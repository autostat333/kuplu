...
mongo.connect('mongodb://localhost:27017/kuplu',function(err,db_)
	{
	db = db_;
	start();
	})
...
function start()
	{
	async.each(categories,function(el,callback)
		{
		db.collection('regions').insert(el,callback);
  ...
  {name:"Днепропетровская область", cities:[
  ...
  {name:"Житомирская область", cities:[
  ...
  {name:"Закарпатская область", cities:[
  ...
  {name:"Запорожская область", cities:[
  ...
  {name:"Ивано-Франковская область", cities:[
  ...
  {name:"Кировоградская область", cities:[
  ...
  {name:"Николаевская область", cities:[
  ...
  {name:"Полтавская область", cities:[
  ...
  {name:"Тернопольская область", cities:[
  ...
  {name:"Харьковская область", cities:[
  ...
  {name:"Херсонская область", cities:[
  ...
  {name:"Хмельницкая область", cities:[
  ...
  {name:"Черкасская область", cities:[
  ...
  {name:"Черниговская область", cities:[
  ...
  {name:"Черновицкая область", cities:[
